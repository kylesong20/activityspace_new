<template>
  <div class="app-container">
    ...
    <!-- 工具条 -->
    <div>
      <el-button v-if="hasPerm('user.add')" size="mini" type="primary" @click="addUser()">添加</el-button>
      <el-button v-if="hasPerm('user.remove')" size="mini" type="danger" @click="removeRows()">批量删除</el-button>
      ...
      <el-table-column label="操作" width="230" align="center">
        <template slot-scope="scope">
          <router-link :to="'/acl/user/role/'+scope.row.id">
            <el-button v-if="hasPerm('user.assgin')" icon="el-icon-info" size="mini" type="info" />
          </router-link>
          <router-link :to="'/acl/user/update/'+scope.row.id">
            <el-button v-if="hasPerm('user.update')" icon="el-icon-edit" size="mini" type="primary" />
          </router-link>
          <el-button
